...
src: '/peacock.jpeg',
caption:
'Polidish.blog the Outpost Outlyer where luxury adjacent partners meet High Worth While Individuals (HWWI).',
duration: 60000,
},
];
...
>
THE VENUE BLOG FOR UNCENSORED POLITICAL DISCOURSE. 18+
</div>
</header>
...
<>
<strong>
You are a verified author. Member submitted extended release vines appear in the vine.
</strong>
<div>Add your vine below.</div>
</>
) : (
<strong>
You're invited to join the discussion. Please type your email address and select join at polidish.com, then click the Magic-link inside your email.
</strong>
)}
</div>
